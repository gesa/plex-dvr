...
const COMSKIP_INI = resolve(__dirname, '..', '..', 'comskip.ini');
...
const COMCUT_OPTS = [`--comskip-ini="${COMSKIP_INI}"`, '--keep-meta'];
...
const HANDBRAKE_OPTS = [
  ...
  '--rate', '30',
  '--pfr',
  '--encoder', '_VIDEO_ENCODER_',
  '--encoder-preset', '_VIDEO_PRESET_',
  '--audio-lang-list', 'eng',
  '--first-audio',
  '-E', 'copy',
  '--srt-lang', 'eng',
